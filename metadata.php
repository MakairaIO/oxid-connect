...
$aModule = [
    ...
    'files'       => [
        ...
        'makaira_connect_basecontroller'            => "{$moduleId}/src/oxid/application/controllers/makaira_connect_basecontroller.php",
        'makaira_connect_reviewcontroller'          => "{$moduleId}/src/oxid/application/controllers/makaira_connect_reviewcontroller.php",
        'makaira_connect_usercontroller'            => "{$moduleId}/src/oxid/application/controllers/makaira_connect_usercontroller.php",
        'makaira_connect_cartcontroller'            => "{$moduleId}/src/oxid/application/controllers/makaira_connect_cartcontroller.php",
    ],
    'templates'   => [
